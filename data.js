...
const MAJOR_ROWS = [
 ...
 ['development-economics','Ekonomi Pembangunan','Bisnis & Ekonomi',true,58,false,'Menganalisis pertumbuhan, kemiskinan, ketimpangan, dan kebijakan pembangunan.','Memerlukan ekonomi, statistik, riset, dan pemahaman masalah sosial.',95,85,90,45,50,35,40,70,80,70,90,55,35,75,'NUM<35:15'],
 ['regional-development','Pembangunan Wilayah','Lingkungan',true,56,true,'Merancang pengembangan wilayah berdasarkan potensi ekonomi, sosial, dan lingkungan.','Memadukan analisis spasial, kerja lapangan, dan perencanaan pembangunan.',80,65,85,55,55,50,60,75,85,75,70,55,35,100,'ENV<30:15'],
 ['regional-economic-development','Pembangunan Ekonomi Kewilayahan','Bisnis & Ekonomi',true,58,true,'Mengembangkan ekonomi daerah melalui analisis potensi, data, dan strategi wilayah.','Memadukan ekonomi, data, kebijakan daerah, dan pemahaman spasial.',90,80,90,50,55,45,45,70,80,75,90,55,30,95,'NUM<35:15;ENV<30:15'],
